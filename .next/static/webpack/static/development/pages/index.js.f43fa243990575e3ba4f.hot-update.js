...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Home, [{
    ...
    value: function updateScorerGoals(event, id) {
      var scorerIndex = this.state.topScorers.findIndex(function (p) {
        return p.id === id;
      });
      ...
      var topScorers = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this.state.persons);

      topScorers[scorerIndex] = person;
      this.setState({
...
//# sourceMappingURL=index.js.f43fa243990575e3ba4f.hot-update.js.map