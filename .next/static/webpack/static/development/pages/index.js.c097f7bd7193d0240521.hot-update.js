...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Home, [{
    ...
    value: function updateScorerGoals(event, id) {
      var scorerIndex = this.state.topScorers.findIndex(function (scorer) {
        return scorer.playerId === id;
      });
      console.log(id);

      var scorer = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, this.state.topScorers[scorerIndex]);

      scorer.goals = event.target.value;

      var topScorers = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this.state.topScorers);
    ...
    value: function render() {
      return __jsx(react__WEBPACK_IMPORTED_MODULE_9___default.a.Fragment, null, __jsx("h1", {
        ...
        updateScorerGoals: this.updateScorerGoals,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 69
        },
...
//# sourceMappingURL=index.js.c097f7bd7193d0240521.hot-update.js.map